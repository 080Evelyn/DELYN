...
const testimonials = [
  {
    ...
    company: "Lagos Distribution Ltd",
    testimonial:
      "DELYN has revolutionized our inventory tracking. We've eliminated stock discrepancies and improved our operational efficiency by 40%. Highly recommended for any distribution business!",
    avatar: "",
  },
  {
    id: 2,
    ...
    company: "Nigerian Logistics Group",
    testimonial:
      "The staff approval workflows have streamlined our processes immensely. No more manual paperwork – everything is digital and automated. This tool has saved us countless hours!",
    avatar: "",
  },
  {
    id: 3,
    ...
    company: "Abuja Wholesale Co.",
    testimonial:
      "DELYN's delivery management system has transformed how we handle logistics. The Real-time tracking and automated notifications keep our team informed. The interface is intuitive and easy to use for everyone. We didn't want to get this before, but at the end of the day, we are glad we did.",
    avatar: "",
  },
  {
    id: 4,
    ...
    company: "Corporate Supply Nigeria",
    testimonial:
      "Since implementing DELYN, our operational transparency has improved dramatically. We now have full visibility into inventory, staff, and deliveries. The best investment for our business operations.",
    avatar: "",
  },
  {
    id: 5,
    ...
    company: "Kaduna Enterprises",
    testimonial:
      "The internal notifications and alerts feature keeps our team connected. We've reduced errors and improved communication across all departments. Excellent support from the team too!",
    avatar: "",
  },
  {
    id: 6,
    ...
    designation: "CEO",
    company: "Port Harcourt Traders",
    testimonial:
      "DELYN has digitized our entire operations. From inventory to deliveries, everything is now efficient and scalable. A game-changer for Nigerian businesses looking to modernize.",
    avatar: "",
  },
];
...
const Testimonials = () => (
  <section
    id="testimonials"
    className="min-h-screen flex justify-center items-center py-30 px-6"
  >
    <div>
